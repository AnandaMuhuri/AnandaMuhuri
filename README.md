...
- 🌐 **Web Development**: HTML, CSS, JavaScript, TypeScript, React, Node.js, Golang
...
- 💼 **Software Development Engineer (Backend)** at [Stashfin].  
- 🚀 **SDE Intern (Fullstack)** at [Stashfin].  
- 🤖 **AI Intern** at [National Informatics Centre (NIC)].  
